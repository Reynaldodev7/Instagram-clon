...
function cargarDatosUsuario(){
    ...
    let headerPerfil = document.querySelector(".header-perfil");
    let div = document.createElement("div");
    div.classList.add("foto-perfil1");
    let img = document.createElement("img");
    let headerPerfil1 = document.querySelector(".header-perfil1");
    let headerPerfil3 = document.querySelector(".header-perfil3");
    let span2 = document.createElement("span");

    let usuario = headerPerfil1.children[0].textContent;

    let nombreUsuario = new FormData();
    nombreUsuario.append("nombre", usuario);

    fetch("../php/pedir_datos_otro_perfil.php", {
    ...
    .then((dato) => {
        ...
        img.setAttribute("src", "../img/perfil/"+dato[1]);
        div.appendChild(img);
        headerPerfil.prepend(div);

        span2.innerHTML = dato[0];
        headerPerfil3.appendChild(span2);
    });
}
...
function pedirPublicaciones(){
    ...
    fetch("../php/cargar_publicaciones_otro_perfil.php")
    .then((response) => {
...
function cargarSeguir(){

    let headerPerfil = document.querySelector(".header-perfil1");
    let seguir = headerPerfil.children[1];

    fetch("../php/cargar_seguir.php")
    .then((response) => {
...
function seguidos(){
    ...
    fetch("../php/seguidos_otroUsuario.php")
    .then((response) => {
    ...
    .then((dato) => {
        ...
        seguidos.classList.add("pointer");
...
function seguidores(){
    ...
    fetch("../php/seguidores_otroUsuario.php")
    .then((response) => {
    ...
    .then((dato) => {
        ...
        seguidores.classList.add("pointer");
...
function cargarSeguidores(){
    ...
    seguidores.addEventListener("click", async () => {
        ...
        let peticion = await fetch("../php/mostrar_seguidores.php");
...
function cargarSeguidos(){
    ...
    seguidos.addEventListener("click", async () => {
        ...
        let peticion = await fetch("../php/mostrar_seguidos.php");
        let respuesta = await peticion.json();
