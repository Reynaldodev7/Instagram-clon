...
function menu(){
    ...
    busqueda.addEventListener("click", () => {
        ...
        let displayBusqueda = window.getComputedStyle(containerBusqueda);
        displayBusqueda = displayBusqueda.getPropertyValue("display");

        if(displayBusqueda == "none" && window.innerWidth <= 760){
        ...
        else if(displayBusqueda == "block" && window.innerWidth <= 760){

            containerBusqueda.style.display = "none";
        }
        else if(display == "block" || containerNotificaciones.style.display == "block"){
    ...
    notificaciones.addEventListener("click", async () => {
        ...
        let displayNotificacion = window.getComputedStyle(containerNotificaciones);
        displayNotificacion = displayNotificacion.getPropertyValue("display");

        if(displayNotificacion == "none" && window.innerWidth <= 760){
        ...
        else if(displayNotificacion == "block" && window.innerWidth <= 760){

            containerNotificaciones.style.display = "none";
        }

        else if(display == "block" || containerBusqueda.style.display == "block"){
...
async function mostrarPublicaciones(array){
    ...
    for(let nombreImg of array){
        ...
        if((nombreImg[0].indexOf(".mp4")) < 0){ 
            ...
            divImgPublicacion.appendChild(img2);
            img2.setAttribute("src", "../img/publicaciones/"+nombreImg[0]);
        }
        else{
...
function busquedaUsuarioHeader(){
    ...
    search.addEventListener("input", async () => {
        ...
        let cargarUsuariosHeader = document.querySelector(".cargar-usuarios-header");

        if(busqueda != ""){

            let divContainerNotificaciones = document.querySelector(".container-notificaciones-header");

            if(divContainerNotificaciones != undefined){


                console.log("entro 1");
                if(divContainerNotificaciones.style.display == "block"){

                    divContainerNotificaciones.style.display = "none";
                    console.log("entro 2");
                }
            }

            cargarUsuariosHeader.style.display = "block";
            ...
            if(respuesta[0] != "No existe ese usuario"){
                ...
                let containerBusqueda = document.querySelector(".container-busqueda-header");
                let containerUsuarios = document.querySelectorAll(".container-usuarios-header");
                ...
                for(let datos of respuesta){
                    ...
                    divUsuario.classList.add("container-usuarios-header");
                    ...
                    cargarUsuariosHeader.appendChild(divUsuario);
            ...
            cargarUsuariosHeader.style.display = "none";
...
busquedaUsuarioHeader();

async function cargarNotificacionesHeader(){
    ...
    if(respuestaNotificaciones[0] != "0"){
        ...
        let divCargarNotificaciones = document.querySelector(".cargar-notificaciones-header");
        let divContainerNotificaciones = document.querySelectorAll(".container-notificaciones-usuarios-header");
        ...
        for(let datos of respuestaNotificaciones){
            ...
            if(datos[1] == "publicacion"){
                ...
                let divContainerNotificacioneUsuario = document.createElement("div");
                divContainerNotificacioneUsuario.classList.add("container-notificaciones-usuarios-header");
                let div1 = document.createElement("div");
                let div2 = document.createElement("div");
                let div3 = document.createElement("div");
                let img1 = document.createElement("img");
...
async function notificacioneHeader(){

    let menuHeaderNotificaciones = document.querySelector(".menu-header-notificaciones");
    let containerNotificacionesHeader = document.querySelector(".container-notificaciones-header");

    menuHeaderNotificaciones.addEventListener("click", async () => {

        let divCargarUsuariosHeader = document.querySelector(".cargar-usuarios-header");

        if(divCargarUsuariosHeader != undefined){

            if(divCargarUsuariosHeader.style.display == "block"){

                divCargarUsuariosHeader.style.display = "none";
            }
        }

        let display = window.getComputedStyle(containerNotificacionesHeader);
        display = display.getPropertyValue("display");

        if(display == "none"){

            await cargarNotificacionesHeader();
            containerNotificacionesHeader.style.display = "block";
        }
        else if(display == "block"){

            containerNotificacionesHeader.style.display = "none";
        }
    })
}
